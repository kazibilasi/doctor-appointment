  ...
  return (
    <div>
      ...
      <div className=" flex flex-col sm:flex-row items-start gap-5 mt-5">
        <button className={`${showFilter ? 'bg-primary text-white' : ''}  py-1 px-3 border rounded text-sm transiton-all sm:hidden`} onClick={()=>setShowfilter(prev => !prev)}>Filter</button>
